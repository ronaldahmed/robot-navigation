# Two implementations of topological sort algorithms in Python (one based on Tim Peter's
# code). These allow you to do dependency resolution by supplying a collection of nodes and the arcs
# between them. Both report results as lists of generations which can be simultaneously executed.
# http://vrplumber.com/programming/
